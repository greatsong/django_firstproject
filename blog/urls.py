...
urlpatterns = [
    ...
    url(r'^comment/(?P<post_id>[0-9]+)/approve/$', views.comment_approve, name='comment_approve'),
    url(r'^comment/(?P<post_id>[0-9]+)/remove/$', views.comment_remove, name='comment_remove'),
]
